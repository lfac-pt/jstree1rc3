...
(function ($) {
	...
	$(function () {
		var css_string = '' + 
			...
			'#vakata-contextmenu li.vakata-separator { min-height:1px; height:1px; line-height:1px; font-size:1px; overflow:hidden; margin:0 2px; background:silver; /* border-top:1px solid #fefefe; */ padding:0; } ';
		$.vakata.css.add_sheet({ str : css_string, title : "vakata" });
		$.vakata.context.cnt
